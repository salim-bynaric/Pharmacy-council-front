...
const SubjectiveQBUpload = (props) => {
    ...
    const formik = useFormik({
        ...
        {
            setMyMsg('');
            await UpQB(values.file,setMyMsg,setLoading,props,currentUser);
...
function download()
{
    ...
    const response = {
        file: serverPath+'standardFormats/SubjectiveQuestionSet.xlsx',
      };
    window.open(response.file);
}

async function UpQB(file,setMyMsg,setLoading,props,currentUser)
{
    setLoading(true);
    let fd = new FormData();
    fd.append("file", file);
    fd.append("psetter",currentUser.uid);
    ...
    await API.post('/subject/question/uploadSubjective',fd,config)
    .then(function (res) 
    {
...
export default SubjectiveQBUpload;