                                                    ...
                                                    <tr>
                                                        ...
                                                        <td> 
                                                            <select id="videoAudio" name="videoAudio" className="form-control" onChange={handleChange} onBlur={handleBlur} value={values.videoAudio} disabled={values.proctoringType === 'V' || values.proctoringType === 'A' ? false : true}>
                                                                ...
                                                                <option value="A">Only Audio</option>
                                                            </select>
    ...
    await API.put('/subject/config/' + paperId, { 'score_view': values.score_view, 'review_question': values.review_question, 'proctoring': values.proctoring, 'photo_capture': values.photo_capture, 'capture_interval': values.capture_interval, 'negative_marking': values.negative_marking, 'negative_marks': values.negative_marks, 'time_remaining_reminder': values.time_remaining_reminder, 'exam_switch_alerts': values.exam_switch_alerts, 'option_shuffle': values.option_shuffle, 'question_marks': values.question_marks, 'ph_time': values.ph_time, 'static_assign': values.static_assign, 'questwisetimer': values.questwisetimer, 'secperquest': values.secperquest, 'exam_switch': values.exam_switch,'warningDriver':values.warningDriver,'warningType':values.warningType,'singleFileUpload':values.singleFileUpload,"clearResponse":values.clearResponse,"proctorMultilogin":values.proctorMultilogin,"collaborativeQB":values.collaborativeQB,"proctoringType":values.proctoringType,"videoAudio":values.videoAudio,"resolution":values.resolution ,"flexi_photo_capture":values.flexi_photo_capture,"useTestCode":values.useTestCode,"student_attendance":values.student_attendance})
        .then(function (res) 
        {
            ...
            if (res.data.status === 'success') 
            {
                ...
                props.location.state.data.exam_switch = values.exam_switch;
                ...
                props.location.state.data.questwisetimer = values.questwisetimer;
                props.location.state.data.secperquest = values.secperquest;
                props.location.state.data.warningDriver= values.warningDriver;
                props.location.state.data.warningType= values.warningType;
                props.location.state.data.singleFileUpload= values.singleFileUpload;
                props.location.state.data.clearResponse= values.clearResponse;
                props.location.state.data.proctorMultilogin= values.proctorMultilogin;
                props.location.state.data.collaborativeQB= values.collaborativeQB;
                props.location.state.data.proctoringType= values.proctoringType;
                props.location.state.data.videoAudio= values.videoAudio;
                props.location.state.data.resolution= values.resolution;
                props.location.state.data.flexi_photo_capture= values.flexi_photo_capture;
                props.location.state.data.useTestCode= values.useTestCode;
                props.location.state.data.student_attendance= values.student_attendance;
