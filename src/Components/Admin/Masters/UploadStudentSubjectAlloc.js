  ...
  return (
    <div className="col-xl-12">
            ...
            <div className="form-group">
              <div className="col-lg-12 row">
                <div className="col-lg-12">
                  ...
                  />
                  {formik.errors.file ? (
                    <div className="alert alert-info">{formik.errors.file}</div>
                  ) : null}
                </div>
              </div>
            </div>
              ...
              {totalRows !== undefined ? (
                <>
                  <ProgressBar
                    ...
                    now={proecessedRows}
                    key={1}
                    label={`${Math.round((proecessedRows / totalRows) * 100)}%`}
                  />
                </>
              ) : null}
      ...
      {errorMsg !== undefined ? (
        <UploadWarningModal
          errorMsg={errorMsg}
          header={"Program Upload Warnings"}
...
function download() {
  ...
  const response = {
    file: serverPath + "standardFormats/studentSubjectAlloc.xlsx",
  };
  window.open(response.file);
}

async function UpStudentSubjectAlloc(
  file,
  setMyMsg,
  myList,
  setMyList,
