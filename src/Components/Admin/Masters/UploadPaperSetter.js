...
const UploadPaperSetter = (props) => {
    ...
    const formik = useFormik({
        ...
        {
            setMyMsg('');
            await UpPaperSetter(values.file,setMyMsg,props.myList,props.setMyList,setLoading);
...
function download()
{
    ...
    const response = {
        file: serverPath+'standardFormats/papersetter.xlsx',
      };
    window.open(response.file);
}
async function UpPaperSetter(file,setMyMsg,myList,setMyList,setLoading)
{
    setLoading(true);
    let fd = new FormData();
    fd.append("file", file);
...
export default UploadPaperSetter;