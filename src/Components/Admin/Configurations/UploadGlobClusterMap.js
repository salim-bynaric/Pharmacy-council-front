...
const UploadGlobClusterMap = (props) => {
                ...
                <div className="card mb-4">
                    <form id="form-QB" method="post" className="form-horizontal" onSubmit={formik.handleSubmit}>
                        <div className="card-header">
                            ...
                            Upload Global To Cluster Admin Mapping
...
function download()
{
    ...
    const response = {
        file: serverPath+'standardFormats/GlobalToClusterMap.xlsx',
      };
...
async function UpMapping(file,setMyMsg,setLoading,props,currentUser)
{
    ...
    let fd = new FormData();
    fd.append("file", file);
    fd.append("type","clusterToGlobMapping");
...
export default UploadGlobClusterMap;