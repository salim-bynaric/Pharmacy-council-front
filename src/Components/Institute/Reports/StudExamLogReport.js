    ...
    return (
        currentUser ? <Formik
            ...
            onSubmit={async (values, actions) => {
                ...
                {
                    setShow(true);
                    setMsg('Please Provide Institute...');
                }
                setLoading(true);
                await getStudentExamLog(values, setLog, setMyMsg, setShow, setMsg);
                setLoading(false);
            }}
                        ...
                        <div>
                            <div className="container-fluid">
                                ...
                                <ol className="breadcrumb mb-4">
                                    <li className="breadcrumb-item active">Student Examination Log Report</li>
                                </ol>
                                        ...
                                        <form id="studExamLogFRM" method="post" className="form-horizontal" onSubmit={handleSubmit}>
                                            <div className="card mb-4">
                                                <div className="card-header">
                                                    ...
                                                    Student Examination Log Report
                                                </div>
...
async function getStudentExamLog(values, setLog, setMyMsg, setShow, setMsg) {
    await API.get('/exam/log/' + values.enrollno + '/' + values.paperId,{params:{"instId":values.instId}})
        .then((res) => {
            if (res.data.status === 'success') 
            {
...
export default StudExamLogReport;