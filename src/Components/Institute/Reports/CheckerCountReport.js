...
const CheckerCountReport = () => {
    ...
    useEffect(() => {
        if (currentUser) {
            getCheckerData(setCheckerData, setShow, setMsg, currentUser);
        }
    }, [currentUser]);
        ...
        currentUser ?
            <div>
                <div className="container-fluid">
                    <h1 className="mt-4">Checker Count Report</h1>
                    <ol className="breadcrumb mb-4">
                        <li className="breadcrumb-item active">Checker Count Report</li>
                    </ol>
...
async function getCheckerData(setCheckerData, setShow, setMsg,currentUser) {
    await API.get('/checker/allocation', { params: { 'type': 'instwise', 'inst':currentUser.inst_id} })
        .then((res) => {
...
export default CheckerCountReport;